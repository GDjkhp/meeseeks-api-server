...
function parseURL(req_url) {
  //console.log(req_url);
  if (req_url == "mee6.xyz/api/plugins/levels/leaderboard/") return null;
...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    var domain = "mee6.xyz/api/plugins/levels/leaderboard/";
    var location = parseURL(domain + req.url.slice(1));
    ...
    var proxyBaseUrl = 'https://' + req.headers.host;
